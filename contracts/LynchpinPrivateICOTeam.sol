...
contract LynchpinPrivateICO is Ownable(0xAc983022185b95eF2B2C7219143483BD0C65Ecda)
{
    ...
    uint256 public maxTokensToSell = 1000000 * 10**18;
    uint256 public tokenSold;
    bool crowdsaleClosed = false;

    uint256 LOCK_PERIOD_START    = 1554076800;    // Wednesday, May 1, 2019 12:00:00 AM         start time
    uint256 LOCK_PERIOD_END      = 1585699200;    // Friday, May 1, 2020 12:00:00 AM            12th month done - lock-in period ends
    ...
    function withdrawMyTokens () external
    {
        ...
        lynT.transfer(msg.sender, tokenBought);
    }
